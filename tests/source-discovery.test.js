...
test('official career URL heuristic rejects aggregators but keeps ATS and career pages', () => {
...
test('discovery queue respects retry backoff and audit attempts are persistent', () => {
  ...
  const queue = buildDiscoveryQueue(records, { companies: { [key]: { nextCheckAfter: future, attempts: 2 } } }, { limit: 10, now: new Date('2026-09-09T00:00:00Z') });
