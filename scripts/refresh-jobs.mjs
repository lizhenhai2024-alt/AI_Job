...
import { dedupeById, dedupePreferOfficial } from './job-discovery/dedupe.mjs';
...
// 本地那份有损的 dedupePreferOfficial 已删除：合并同键记录时会直接丢弃落选方证据，
// 导致跨源证据一直失效。改用 dedupe.mjs 的合并版（见该文件 mergeEvidence）。
