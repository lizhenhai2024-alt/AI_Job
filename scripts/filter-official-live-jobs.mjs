...
// 具体专业只有在出现“专业/专业背景/学科/方向”等明确专业语义时才直接硬判。
// 单独的“计算机、电子信息相关背景”可能描述经历背景，保留给下游 evidence 判断，避免误杀。
const SPECIFIC_PROFESSIONAL_MAJOR_RX = /(?:计算机|软件工程|人工智能|电子信息|电子科学|电子|通信|机械|车辆工程|汽车|自动化|电气|微电子|集成电路|材料|能源|动力|化工|化学|物理|数学|统计|数据科学|土木|建筑|交通工具设计|工业设计|产品设计|汽车设计|造型设计|设计学|视觉传达|环境设计|服装设计|生物|医学|药学|临床|会计|财务管理|审计|税务|金融学|精算|法学|法律|知识产权|工商管理|市场营销|国际商务|国际贸易|人力资源|管理科学).{0,14}(?:专业|专业背景|学科|方向)/i;
const MAJOR_UNLIMITED_RX = /专业不限|不限专业|无专业限制|不限制专业|不限学科|专业不作限制/i;
const SOFT_MAJOR_RX = /优先|加分|更佳|者佳|优先考虑|preferred|prefer/i;
// “英语”只有在明确处于专业并列结构时才视为英语专业兼容；“英语流利/CET-4”仍只是语言能力。
const ENGLISH_COMPATIBLE_MAJOR_RX = /(?:英语专业|英语语言文学|外国语言文学|外语类|语言类|翻译(?:专业|方向)?|文学类|文科类|人文社科(?:类)?|英语(?=\s*(?:、|\/|或|及|与|和).{0,12}(?:专业|学科|方向)))/i;
